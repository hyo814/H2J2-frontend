...
import Fassionpage from "./Fassionpage";
import './style.css';
...
class FassionList extends Component {
    constructor(props){
        super(props);
        this.state = {
            completed: 0,
    ...
    render() {
        return (
            <>
                <div>
                    <Fassionpage Clothes={this.state.clothes} stateRefresh={this.stateRefresh} />
                </div>
                <PaginationButton
...
export default withStyles(styles)(FassionList)