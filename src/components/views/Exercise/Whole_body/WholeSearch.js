...
class WholeSearch extends Component {
    constructor(props){
        super(props);
        this.state = {
            completed: 0,
    ...
    searchVideo = (title) => {
        axios.get('http://h2j22020.vps.phps.kr:5000/api/exercise/whole_body/search?title='+title)
            .then(({ data }) => {
                this.setState({
                    loading: true,
                    videos: data,
...
export default withStyles(styles)(WholeSearch)
